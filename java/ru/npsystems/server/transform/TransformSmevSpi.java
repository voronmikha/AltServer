...
import ru.npsystems.server.transform.CanonicalizationException;
import ru.npsystems.server.transform.InvalidCanonicalizerException;
import ru.npsystems.server.transform.TransformationException;
import ru.npsystems.server.transform.XMLSignatureInput;
...
public class TransformSmevSpi extends TransformSpi {
